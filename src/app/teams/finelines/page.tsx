...
const teamData = {
  name: 'FINE LINES',
  tagline: 'Performance Art Collective',
  founded: '2024',
  accent: '#bb86fc',
  gradientFrom: '#140a1a',
  gradientTo: '#1a1a1a',
  description:
    'Fine Lines is EvenGround\'s performance-focused collective that blurs the line between dance and art. The team explores choreography through storytelling, visual concepts, and cross-genre movement. Fine Lines pushes creative boundaries and brings a unique artistic perspective to the Austin dance scene.',
