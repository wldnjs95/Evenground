...
const teamData = {
  name: 'FUNDIES',
  tagline: 'Foundations Dance Team',
  founded: '2024',
  accent: '#4ecdc4',
  gradientFrom: '#0a1a17',
  gradientTo: '#1a1a1a',
  description:
    'Fundies is EvenGround\'s foundations-focused team designed for dancers who want to build strong fundamentals while being part of a supportive crew. The team emphasizes groove, musicality, and the roots of street dance styles. Perfect for dancers looking to level up from classes to team training.',
  styles: ['Hip Hop', 'Popping', 'House', 'Waacking'],
  members: [
    { name: 'Member 1', role: 'Dancer' },
    { name: 'Member 2', role: 'Dancer' },
...
export default function Fundies() {
  return (
    <>
      <Header />
