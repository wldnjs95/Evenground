...
const teams: Team[] = [
  {
    ...
    members: [
      { name: 'Chris Han', role: 'Director' },
      { name: 'Son Le', role: 'Co-Director' },
      { name: 'Alex Rivera', role: 'Member' },
      { name: 'Jordan Kim', role: 'Member' },
      { name: 'Taylor Nguyen', role: 'Member' },
      { name: 'Morgan Chen', role: 'Member' },
    ],
    achievements: [
  ...
  },
  {
    ...
    members: [
      { name: 'Riley Park', role: 'Captain' },
      { name: 'Casey Tran', role: 'Co-Captain' },
      { name: 'Jamie Osei', role: 'Member' },
      { name: 'Drew Santos', role: 'Member' },
      { name: 'Quinn Patel', role: 'Member' },
      { name: 'Avery Liu', role: 'Member' },
    ],
    achievements: [
  ...
  },
  {
    ...
    members: [
      { name: 'Sage Morales', role: 'Creative Director' },
      { name: 'Kai Yamamoto', role: 'Choreographer' },
      { name: 'Ellis Dunn', role: 'Member' },
      { name: 'Reese Adler', role: 'Member' },
      { name: 'Rowan Blake', role: 'Member' },
      { name: 'Harper Song', role: 'Member' },
    ],
    achievements: [
      'Performed at Austin art events',
...
export default function TestingTeamsPage() {
